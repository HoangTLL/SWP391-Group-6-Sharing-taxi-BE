...
using PMS.Repository.Base; // Using GenericRepository from PMS.Repository.Base
...
namespace STP.Repository.Repository
{
    ...
    public class AreaRepository : GenericRepository<Area>
    {
        ...
        // Asynchronous method to retrieve all Areas, including related Locations and Trips
        public async Task<List<Area>> GetAllAsync()
        {
            return await _context.Areas
                .Include(a => a.Locations) // Include related Locations
                .Include(a => a.Trips) // Include related Trips
                .ToListAsync(); // Return the list asynchronously
        }

        // Asynchronous method to retrieve a specific Area by its ID, including related Locations and Trips
        ...
        // Asynchronous method to add a new Area entity
